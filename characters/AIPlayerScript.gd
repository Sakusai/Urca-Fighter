...
#Object
@onready var animTree = $AnimationTree.get("AnimatedSprite2D") # Get the AI animationtree
@onready var player = get_parent().get_node(PlayerData.player1)  # Target to focus the player1

#References
var generalMoves = animTree.get_animation()
